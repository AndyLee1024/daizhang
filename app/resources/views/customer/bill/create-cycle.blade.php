            ...
            <div class="row">
                ...
                <div class="col-md-10">
                    ...
                    <div class="panel panel-default panel-hovered panel-stacked mb30">
                        <div class="panel-heading">添加周期收款</div>
                            ...
                            <form role="form" class="form-horizontal"  method="post" action=""> <!-- form horizontal acts as a row -->
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-4">
                                        <input type="text" class="form-control date-picker" id="start_date"
                                               name="start_date"
                                               placeholder="开始时间" value="{{\Carbon\Carbon::now()->format('Y-m-d')}}">
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-4">
                                        <select name="rule" id="rule" class="form-control m-b-sm">
                                            ...
                                            <option value="3m">每季度</option>
                                            <option value="12m">每年</option>
                                        </select>
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    <div class="col-sm-offset-2 col-md-4">
                                        ...
                                        <button type="submit" class="btn btn-primary">创建收款周期</button>
                                    </div>
                                </div>
