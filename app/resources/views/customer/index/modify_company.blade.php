                        ...
                        <div class="panel panel-white">
                            ...
                            <div class="panel-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control date-picker" id="register_time" name="register_time" value="{{date('Y-m-d', $company->register_time)}}">
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label for="end_time" class="col-sm-2 control-label">经营期限结束</label>
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control date-picker" id="end_time" name="end_time" value="{{date('Y-m-d', $company->end_time)}}">
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label for="register_number" class="col-sm-2 control-label">工商注册号</label>
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control" id="register_number" name="register_number" value="{{$company->register_number}}">
                                    </div>
                                </div>
                                <div class="form-group">
