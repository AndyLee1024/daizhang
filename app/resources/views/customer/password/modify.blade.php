            ...
            <div class="row">
                ...
                <div class="col-md-8">
                    ...
                    <div class="panel panel-default panel-hovered panel-stacked mb30">
                        <div class="panel-heading">编辑账号密码 </div>
                        <div class="panel-body">
                            <form class="form-horizontal" method="post">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-3">
                                        <input type="text" class="form-control" name="site_name" id="site_name" value="{{$password->site_name}}" placeholder="请输入网站名称">
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-3">
                                        <input type="text" class="form-control" value="{{$password->login_name}}" name="username" id="username" placeholder="请输入用户名称">
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-3">
                                        <input type="password" class="form-control"  name="password" value="{{Crypt::decrypt($password->password)}}" id="password" placeholder="请输入登录密码">
                                    </div>
                                    <div class="col-sm-2">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-3">
                                        <select name="account_type" id="account_type" class="form-control">
                                            ...
                                            <option @if($password->account_type == $k) selected @endif value="{{$k}}">{{$k}}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-7">
                                        <input type="text" class="form-control"  name="site_url" id="site_url" value="{{$password->site_url}}" placeholder="请输入登录网址">
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-7">
                                        <textarea name="remarks" id="remarks" class="form-control">{{$password->remarks}}</textarea>
                                    </div>
                                </div>
