    ...
    <div class="col-md-10">
        ...
        <div class="panel panel-white">
            <div class="panel-heading clearfix">
                <h4 class="panel-title">编辑银行账户</h4>
            </div>
            ...
            <div class="panel-body">
                <form action="" method="post" name="queryForm">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-5">
                            <div class="form-group">
                                ...
                                <input type="text" name="card_name" value="{{$account->account_name}}" class="form-control" id="card_name"
                                       placeholder="请输入卡片名称">
                            </div>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-md-5">
                            <div class="form-group">
                                ...
                                <input type="text" name="account" value="{{$account->account}}" class="form-control" id="account"
                                       placeholder="请输入银行账户">
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-md-3">
                            <div class="form-group">
                                <label for="credits">开户人姓名</label>
                                <input type="text" name="register_user_name" value="{{$account->register_user_name}}" class="form-control" id="credits"
                    ...
                    <div class="row">
                        <div class="col-md-3">
                            <div class="form-group">
                                <label for="credits">开户人手机号码</label>
                                <input type="text" name="phone" class="form-control" value="{{$account->register_mobile}}" id="register_user_mobile" placeholder="请输入开户人手机号码">
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <div class="bs-chinese-region flat dropdown" data-submit-type="id" data-min-level="1" data-max-level="3">
                                    <input type="text" class="form-control" name="address" id="address" placeholder="选择你的地区" data-toggle="dropdown" readonly="" value="{{$account->state_code}}">
                    ...
                    <input type="hidden" id="province_h" value="{{$account->province}}" name="province">
                    <input type="hidden" id="city_h" value="{{$account->city}}" name="city">
                    <input type="hidden" id="town_h" value="{{$account->town}}" name="town">
                    ...
                    <div class="row">
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <input type="text" name="bank_branch" value="{{$account->bank_branch}}" class="form-control" id="bank_branch"
                                       placeholder="请输入支行名称">
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-md-5">
                            <div class="form-group">
                                ...
                                <input type="text" name="bank_url" value="{{$account->bank_url}}" class="form-control" id="bank_url"
                                       placeholder="请输入银行网址">
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-md-5">
                            <div class="form-group">
                                ...
                                <input type="text" name="bank_address" value="{{$account->bank_address}}" class="form-control" id="bank_address"
                    ...
                    <div class="row">
                        <div class="col-md-10">
                            <div class="form-group">
                                ...
                                <textarea class="form-control input-lg" rows="3" name="remarks" id="remarks">{{$account->remarks}}</textarea>
                            </div>
                        </div>
                    </div>
                    ...
                    <a href="{{action('BankAccountController@getDeleteBankAccount', $account->id)}}" class="btn btn-warning">删除此纪录</a>
