...
@section('content')
    ...
    <div class="col-md-10">
        ...
        <div class="row">
            <div class="col-md-3">
                <a href="{{action('CertificateController@getCreateCertificate', $customer_id)}}" class="btn btn-success btn-addon m-b-sm"><i class="fa fa-plus"></i> 添加证照</a>
            </div>
        </div>
                         ...
                         <div class="col-sm-6 col-md-4">
                            <div class="thumbnail">
                                @if(!empty($v['certificate_path']))
                                    <img src="{{unserialize($v['certificate_path'])[0]}}" alt="{{$v['name']}}">
                                @else
